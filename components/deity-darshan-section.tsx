...
export default function DeityDarshanSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-cream-50 via-white to-cream-50 relative overflow-hidden">
      {/* Decorative Background */}
      <div className="absolute inset-0 section-lotus opacity-50" />
      
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-gradient-radial from-saffron-200/30 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-radial from-gold-200/30 to-transparent rounded-full translate-x-1/3 translate-y-1/3" />
      ...
      <div className="container relative">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-maroon-800 mb-4">
            Behold the Divine
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative aspect-[4/3] md:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl shadow-maroon-900/20">
              {/* Decorative Frame */}
              <div className="absolute inset-0 border-4 border-gold-400/50 rounded-3xl z-10 pointer-events-none" />
              <div className="absolute inset-2 border border-gold-300/30 rounded-2xl z-10 pointer-events-none" />
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-maroon-900/60 via-transparent to-maroon-900/20" />
              ...
              {deities.map((deity, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeIndex === index
                      ? "ring-2 ring-saffron-500 ring-offset-2 scale-105"
          ...
          <div className="space-y-8">
            {/* Blessing Card */}
            <div className="bg-gradient-to-br from-saffron-50 to-gold-50 rounded-2xl p-6 md:p-8 border border-saffron-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="font-heading text-lg font-semibold text-maroon-800">
                  Divine Blessing
                </h4>
              </div>
              <p className="text-maroon-700 italic text-lg leading-relaxed font-medium">
                "{deities[activeIndex].blessing}"
              </p>
            </div>

            {/* Temple Timings Quick Info */}
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg shadow-maroon-900/5 border border-cream-200">
              <h4 className="font-heading text-xl font-semibold text-maroon-800 mb-4">
                Darshan Timings
              </h4>
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-cream-100">
                  <span className="text-maroon-600">Mangala Arati</span>
                  <span className="text-saffron-600 font-semibold">4:30 AM</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-cream-100">
                  <span className="text-maroon-600">Shringar Arati</span>
                  <span className="text-saffron-600 font-semibold">7:15 AM</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-cream-100">
                  <span className="text-maroon-600">Raj Bhog Arati</span>
                  <span className="text-saffron-600 font-semibold">12:00 PM</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-maroon-600">Sandhya Arati</span>
                  <span className="text-saffron-600 font-semibold">6:30 PM</span>
                </div>
              </div>
              <Link
                href="/iskcon/vaishnava-calendar"
                className="inline-flex items-center gap-2 mt-4 text-saffron-600 font-medium hover:text-saffron-700 transition-colors"
              >
                View Full Schedule
