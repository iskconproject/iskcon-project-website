      ...
      <div className="container relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="relative">
            <p className="font-heading text-xl md:text-2xl lg:text-3xl text-white leading-relaxed mb-6 transition-all duration-500">
              "{quotes[currentQuote].text}"
            </p>
            
            {/* Source */}
            <footer className="space-y-1">
              <cite className="not-italic text-gold-300 font-semibold text-lg">
          ...
          <div className="mt-12">
            <Link
              ...
              className={cn(
                ...
                "bg-gradient-to-r from-gold-400 to-saffron-500 text-maroon-900 font-semibold",
                "hover:from-gold-500 hover:to-saffron-600",
                "shadow-lg shadow-gold-500/20 hover:shadow-xl",
